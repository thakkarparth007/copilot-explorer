...
A couple of months back I had performed a very shallow ["reverse engineering"](https://twitter.com/parth007_96/status/1546762772708413440) of the extension, and I'd been wanting to do a deeper dive. Finally got around to doing that in the last few weeks. Very roughly, here's what I did -- I looked at the minified [extension.js](../muse/github.copilot-1.57.7193/dist/extension.js) file included with Copilot, performed some minor manual changes to ease automatic extraction of modules, wrote a bunch of AST transforms to "prettify" each module, named and classified the modules and manually annotated a handful of most interesting modules. I plan to write a separate post describing these in detail.
