...
class CopilotListDocument {
  constructor(e, t, n, s, a, c) {
    ...
    this.debouncedEventFire = M_debouncer.debounce(10, () =>
    ...
    this._ctx = e;
    this._uri = t;
    this._showLogprobs = M_config_stuff.getConfig(
      e,
      M_config_stuff.ConfigKey.DebugShowScores
    );
  ...
  areSolutionsDuplicates(e, t) {
    return (
      M_completion_normalizer.normalizeCompletionText(e.completionText) ===
      M_completion_normalizer.normalizeCompletionText(t.completionText)
    );
  }
  insertSorted(e, t, n) {
  ...
  async runQuery() {
    const e = await M_completion_normalizer.launchSolutions(this._ctx, this);
