...
exports.WindowedMatcher = class {
  ...
  findMatches(
    e,
    t = M_prompt_parsing_utils_NOTSURE.SnippetSelectionOption.BestMatch,
    n
  ) {
    if (t == M_prompt_parsing_utils_NOTSURE.SnippetSelectionOption.BestMatch) {
      const t = this.findBestMatch(e);
      return t ? [t] : [];
    }
    return (
      (t == M_prompt_parsing_utils_NOTSURE.SnippetSelectionOption.TopK &&
