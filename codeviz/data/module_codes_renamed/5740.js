var r =
  ...
  u = (function () {
    ...
    e.validateStringMap = function (t) {
        ...
        for (var r in t) {
          ...
          if (e.isPrimitive(i)) o = i.toString();
            ...
            try {
              ...
              M_logging_NOTSURE.info("key: " + r + ", could not be serialized");
            }
          }
      ...
      M_logging_NOTSURE.info("Invalid properties dropped from payload");
    };
    ...
    e.getCorrelationContextTarget = function (e, t) {
      var n =
        e.headers && e.headers[M_request_context_NOTSURE.requestContextHeader];
      if (n)
    ...
    e.makeRequest = function (t, n, a, l) {
      ...
      if (p) {
        ...
        var h = s.parse(p);
        "https:" === h.protocol
          ? (M_logging_NOTSURE.info("Proxies that use HTTPS are not supported"),
            (p = void 0))
          : (d = r({}, d, {
              host: h.hostname,
              port: h.port || "80",
    ...
    e.addCorrelationIdHeaderFromString = function (e, t, n) {
      var r = n.split(","),
        o = M_request_context_NOTSURE.requestContextSourceKey + "=";
      if (
        r.some(function (e) {
