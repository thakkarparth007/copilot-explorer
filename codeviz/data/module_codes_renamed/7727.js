...
exports.isEmptyBlockStart = function (e, t) {
  return M_get_prompt_parsing_utils_maybe.isEmptyBlockStart(
    e.languageId,
    e.getText(),
    e.offsetAt(t)
  );
...
exports.isBlockBodyFinished = function (e, t, n, i) {
  ...
  return M_get_prompt_parsing_utils_maybe.isBlockBodyFinished(
    t.languageId,
    a,
    i,
    c
...
exports.getNodeStart = async function (e, t, n, i) {
  ...
  const c = await M_get_prompt_parsing_utils_maybe.getNodeStart(
    t.languageId,
    a,
    t.offsetAt(n)
  );
