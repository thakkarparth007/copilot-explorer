...
var M_request_info_maybe = require("request_info");
...
var d = (function () {
  ...
  e.prototype.enable = function (e) {
    ...
    if (
      (this._isAutoCorrelating ||
        this._isEnabled ||
        M_performance_monitor_maybe.isEnabled()) &&
      !this._isInitialized
    ) {
    ...
    var n = function (n) {
      if (n) {
        ...
        return function (r, o) {
          ...
          if (r && i) {
            var s = new M_request_info_maybe(r);
  ...
  e.trackRequestSync = function (t, n) {
    if (n.request && n.response && t) {
      ...
      var o = new M_request_info_maybe(n.request, r && r.operation.parentId);
      if (r) {
  ...
  e.trackRequest = function (t, n, r) {
    if (n.request && n.response && t) {
      var o =
        M_correlation_context_manager.CorrelationContextManager.getCurrentContext();
      var a =
        r || new M_request_info_maybe(n.request, o && o.operation.parentId);
      if (M_http_util_maybe.canIncludeCorrelationHeader(t, a.getUrl())) {
        e.addResponseCorrelationIdHeader(t, n.response);
      }
      if (o && !r) {
  ...
  e.addResponseCorrelationIdHeader = function (e, t) {
    if (
      ...
      var n = t.getHeader(M_request_context_maybe.requestContextHeader);
      M_http_util_maybe.safeIncludeCorrelationHeader(e, t, n);
    }
  };
