...
var M_accept_language_maybe = require("accept-language");
...
var h = (function (e) {
  ...
  t.prototype._getId = function (e) {
    var n =
      (this.rawHeaders &&
        ...
        this.rawHeaders.cookie) ||
      "";
    return t.parseId(M_http_util_maybe.getCookie(e, n));
  };
  ...
  t.prototype.parseHeaders = function (e, t) {
    ...
    this.sourceCorrelationId = M_http_util_maybe.getCorrelationContextTarget(
      e,
      M_request_context_maybe.requestContextSourceKey
    );
    if (e.headers) {
      var n = e.headers[M_request_context_maybe.traceStateHeader],
        r = e.headers[M_request_context_maybe.traceparentHeader],
        o = e.headers[M_request_context_maybe.requestIdHeader],
        i = e.headers[M_request_context_maybe.parentIdHeader],
        s = e.headers[M_request_context_maybe.rootIdHeader];
      (this.correlationContextHeader =
        e.headers[M_request_context_maybe.correlationContextHeader]),
        M_app_id_lookup_maybe.w3cEnabled && (r || n)
          ? ((this.traceparent = new M_trace_id_maybe(r)),
            (this.tracestate = r && n && new M_accept_language_maybe(n)),
            this.setBackCompatFromThisTraceContext())
          : o
          ? M_app_id_lookup_maybe.w3cEnabled
            ? ((this.traceparent = new M_trace_id_maybe(null, o)),
              this.setBackCompatFromThisTraceContext())
            : ((this.parentId = o),
              (this.requestId = M_app_id_lookup_maybe.generateRequestId(
                this.parentId
              )),
              (this.operationId = M_app_id_lookup_maybe.getRootId(
                this.requestId
              )))
          : M_app_id_lookup_maybe.w3cEnabled
          ? ((this.traceparent = new M_trace_id_maybe()),
        ...
        t &&
          ((this.requestId = t),
          (this.operationId = M_app_id_lookup_maybe.getRootId(this.requestId)));
    }
  };
  ...
  t.keys = new M_copilot_utils_maybe.ContextTagKeys();
  return t;
