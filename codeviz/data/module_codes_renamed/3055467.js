...
exports.WindowedMatcher = class {
  ...
  findMatches(e, t = M_get_prompt_actual.SnippetSelectionOption.BestMatch, n) {
    if (t == M_get_prompt_actual.SnippetSelectionOption.BestMatch) {
      const t = this.findBestMatch(e);
      return t ? [t] : [];
    }
    return (
      (t == M_get_prompt_actual.SnippetSelectionOption.TopK &&
