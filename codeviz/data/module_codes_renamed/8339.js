var r,
  ...
  d = (function (e) {
    ...
    t.prototype.onResponse = function (e) {
      ...
      this.correlationId = M_http_util_NOTSURE.getCorrelationContextTarget(
        e,
        M_request_context_NOTSURE.requestContextTargetKey
      );
    };
    t.prototype.getDependencyTelemetry = function (e, t) {
      ...
      var r = this.method.toUpperCase() + " " + n.pathname,
        o = M_copilot_utils_NOTSURE.RemoteDependencyDataConstants.TYPE_HTTP,
        a = n.hostname;
      if (this.correlationId) {
        o = M_copilot_utils_NOTSURE.RemoteDependencyDataConstants.TYPE_AI;
        if (
