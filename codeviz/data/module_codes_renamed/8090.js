  ...
  i = (function () {
    function e(t, n) {
      ...
      if (t && "string" == typeof t) {
        if (t.split(",").length > 1)
          (this.traceId = M_http_util_NOTSURE.w3cTraceId()),
            (this.spanId = M_http_util_NOTSURE.w3cTraceId().substr(0, 16));
        else {
          var i = t.trim().split("-"),
            s = i.length;
          s >= 4
        ...
        var a = M_app_id_lookup_NOTSURE.getRootId(n);
        e.isValidTraceId(a) ||
          ((this.legacyRootId = a), (a = M_http_util_NOTSURE.w3cTraceId())),
          -1 !== n.indexOf("|") &&
            (n = n.substring(
