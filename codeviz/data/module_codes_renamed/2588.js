  ...
  d = (function () {
    ...
    e.prototype.send = function (t, n) {
      ...
      s.gzip(t, function (s, a) {
        ...
        M_logging_NOTSURE.info(e.TAG, i);
        i[M_request_tracker_NOTSURE.disableCollectionRequestOption] = !0;
        var p = M_http_util_NOTSURE.makeRequest(r._config, o, i, function (o) {
          o.setEncoding("utf-8");
          var i = "";
        ...
        p.on("error", function (o) {
          ...
          if (
            ...
            r._enableDiskRetryMode &&
              ...
              M_logging_NOTSURE.warn(e.TAG, i, o);
          } else (i = "Transient failure to reach ingestion endpoint. This batch of telemetry items will be retried. Error:"), M_logging_NOTSURE.info(e.TAG, i, o);
          r._onErrorHelper(o);
          if ("function" == typeof n) {
        ...
        n._getShallowDirectorySize(s, function (o, a) {
          ...
          if (a > n._maxBytesOnDisk)
            ...
            var l = new Date().getTime() + ".ai.json",
              u = i.join(s, l);
            M_logging_NOTSURE.info(e.TAG, "saving data to disk at: " + u);
            r.writeFile(
              u,
              t,
              {
    ...
    e.prototype._storeToDiskSync = function (t) {
      ...
      try {
        ...
        if (s > this._maxBytesOnDisk)
          return void M_logging_NOTSURE.info(
            e.TAG,
            "Not saving data due to max size limit being met. Directory size in bytes is: " +
              s
          );
