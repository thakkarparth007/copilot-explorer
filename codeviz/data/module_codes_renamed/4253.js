...
(function () {
  ...
  var d = (i.DES = o.extend({
    _doReset: function () {
      for (e = this._key.words, t = [], n = 0, undefined; n < 56; n++) {
        var e;
        var t;
        var n;
        var r = s[n] - 1;
      ...
      for (o = this._subKeys = [], i = 0, undefined; i < 16; i++) {
        var o;
        var i;
        var l = (o[i] = []);
        var u = c[i];
    ...
    _doCryptBlock: function (e, t, n) {
      ...
      for (var r = 0; r < 16; r++) {
        for (
          o = n[r], i = this._lBlock, s = this._rBlock, a = 0, c = 0, undefined;
          c < 8;
          c++
        ) {
          var o;
  ...
  var f = (i.TripleDES = o.extend({
    _doReset: function () {
      ...
      var t = e.slice(0, 2);
      var r = e.length < 4 ? e.slice(0, 2) : e.slice(2, 4);
...
module.exports = M_random_stuff_maybe.TripleDES;
