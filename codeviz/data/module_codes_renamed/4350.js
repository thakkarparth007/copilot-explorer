  ...
  i = (function () {
    ...
    e.prototype._trackCpu = function () {
      ...
      if (
        ...
        this._client.trackMetric({
          name: M_quickpulse_constants_NOTSURE.PerformanceCounter
            .PROCESSOR_TIME,
          value: ((_ - s) / _) * 100,
        });
        this._client.trackMetric({
          name: M_quickpulse_constants_NOTSURE.PerformanceCounter.PROCESS_TIME,
          value: h || (t / _) * 100,
        });
      }
      this._lastCpus = e;
    ...
    e.prototype._trackMemory = function () {
      var e = r.freemem(),
        ...
        n = r.totalmem() - e;
      this._client.trackMetric({
        name: M_quickpulse_constants_NOTSURE.PerformanceCounter.PRIVATE_BYTES,
        value: t,
      });
      this._client.trackMetric({
        name: M_quickpulse_constants_NOTSURE.PerformanceCounter.AVAILABLE_BYTES,
        value: e,
      });
      if (this._enableLiveMetricsCounters) {
        this._client.trackMetric({
          name: M_quickpulse_constants_NOTSURE.QuickPulseCounter
            .COMMITTED_BYTES,
          value: n,
        });
      }
    ...
    e.prototype._trackNetwork = function () {
      ...
      if (s > 0) {
        var l = r / a,
          u = i / a;
        this._client.trackMetric({
          name: M_quickpulse_constants_NOTSURE.PerformanceCounter.REQUEST_RATE,
          value: l,
        }),
