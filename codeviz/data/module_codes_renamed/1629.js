...
var M_appinsights_config_NOTSURE = require("appinsights-config"),
  ...
  AutoCollectNativePerformance = (function () {
          ...
          try {
            ...
            (e._emitter = new a()),
              ...
              M_logging_NOTSURE.info(
                "Native metrics module successfully loaded!"
              );
          } catch (t) {
    ...
    e.parseEnabled = function (e) {
      var t =
          process.env[M_appinsights_config_NOTSURE.ENV_nativeMetricsDisableAll],
        n =
          process.env[M_appinsights_config_NOTSURE.ENV_nativeMetricsDisablers];
      if (t)
        return {
          isEnabled: !1,
          disabledMetrics: {},
          ...
          this._client.trackMetric({
            ...
            tagOverrides:
              ...
              (t[this._client.context.keys.internalSdkVersion] =
                "node-nativeperf:" + M_default_context_NOTSURE.sdkVersion),
              t),
          });
        }
      }
