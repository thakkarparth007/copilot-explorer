...
var AutoCollectNativePerformance = (function () {
  ...
  e.prototype.enable = function (t, r, o) {
    ...
    if (e.isNodeVersionCompatible()) {
      if (null == e._metricsAvailable && t && !this._isInitialized)
        try {
          var M_applicationinsights_native_metrics = require("applicationinsights-native-metrics");
          (e._emitter = new M_applicationinsights_native_metrics()),
            (e._metricsAvailable = !0),
            M_logging_maybe.info("Native metrics module successfully loaded!");
        } catch (t) {
  ...
  e.parseEnabled = function (e) {
    var t = process.env[M_appinsights_config_maybe.ENV_nativeMetricsDisableAll];
    var n = process.env[M_appinsights_config_maybe.ENV_nativeMetricsDisablers];
    if (t)
      return {
        isEnabled: !1,
        disabledMetrics: {},
        ...
        this._client.trackMetric({
          ...
          tagOverrides:
            ...
            (t[this._client.context.keys.internalSdkVersion] =
              "node-nativeperf:" + M_default_context_maybe.sdkVersion),
            t),
        });
      }
    }
