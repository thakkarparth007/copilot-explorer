...
class o {
  ...
  async getNodeMatchAtPosition(e, t, n) {
    const o = await M_get_prompt_parsing_utils.parseTree(this.languageId, e);
    try {
        ...
        ("class_definition" !=
          ...
          "function_definition" !=
            (null === (o = e.parent) || undefined === o
              ...
              : o.type)) ||
        1 != e.children.length ||
        !M_get_prompt_parsing_utils.queryPythonIsDocstring(e.parent)
      )
    );
  }
  async isEmptyBlockStart(e, t) {
    ...
    t = s(e, t);
    const a = await M_get_prompt_parsing_utils.parseTree(this.languageId, e);
    try {
...
function getBlockParser(e) {
  return u[M_get_prompt_parsing_utils.languageIdToWasmLanguage(e)];
}
exports.getBlockParser = getBlockParser;
exports.isEmptyBlockStart = async function (e, t, n) {
  return (
    !!M_get_prompt_parsing_utils.isSupportedLanguageId(e) &&
    getBlockParser(e).isEmptyBlockStart(t, n)
  );
};
exports.isBlockBodyFinished = async function (e, t, n, o) {
  if (M_get_prompt_parsing_utils.isSupportedLanguageId(e))
    return getBlockParser(e).isBlockBodyFinished(t, n, o);
};
exports.getNodeStart = async function (e, t, n) {
  if (M_get_prompt_parsing_utils.isSupportedLanguageId(e))
    return getBlockParser(e).getNodeStart(t, n);
};
