var M_http_util_NOTSURE = require("http-util"),
  ...
  i = (function () {
      ...
      if (e.completedLookups.hasOwnProperty(i)) n(e.completedLookups[i]);
        ...
        var s = function () {
          if (e.pendingLookups[i]) {
            ...
            M_logging_NOTSURE.info(e.TAG, n);
            var a = M_http_util_NOTSURE.makeRequest(t, i, n, function (n) {
              if (200 === n.statusCode) {
                var r = "";
                n.setEncoding("utf-8");
                ...
                n.on("end", function () {
                  M_logging_NOTSURE.info(e.TAG, r);
            ...
            if (a) {
              a.on("error", function (t) {
                M_logging_NOTSURE.warn(e.TAG, t);
              });
              a.end();
            }
          }
    ...
    e.generateRootId = function () {
      return "|" + M_http_util_NOTSURE.w3cTraceId() + ".";
    };
    e.appendSuffix = function (t, n, o) {
      ...
      for (n = M_http_util_NOTSURE.randomu32().toString(16); n.length < 8; )
        n = "0" + n;
    ...
    e.currentRootId = M_http_util_NOTSURE.randomu32();
    return e;
  })();
module.exports = i;
