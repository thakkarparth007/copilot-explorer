...
var i = (function () {
    ...
    if (e.completedLookups.hasOwnProperty(i)) n(e.completedLookups[i]);
      ...
      var s = function () {
        if (e.pendingLookups[i]) {
          ...
          M_logging_maybe.info(e.TAG, n);
          var a = M_http_util_maybe.makeRequest(t, i, n, function (n) {
            if (200 === n.statusCode) {
              var r = "";
              n.setEncoding("utf-8");
  ...
  e.generateRootId = function () {
    return "|" + M_http_util_maybe.w3cTraceId() + ".";
  };
  e.appendSuffix = function (t, n, o) {
    ...
    for (n = M_http_util_maybe.randomu32().toString(16); n.length < 8; )
      n = "0" + n;
  ...
  e.currentRootId = M_http_util_maybe.randomu32();
  return e;
})();
module.exports = i;
