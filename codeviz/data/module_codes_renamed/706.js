...
(function (e) {
  ...
  var d = o.create([0, 1518500249, 1859775393, 2400959708, 2840853838]);
  var p = o.create([1352829926, 1548603684, 1836072691, 2053994217, 0]);
  var h = (s.RIPEMD160 = i.extend({
    _doReset: function () {
      this._hash = o.create([
    ...
    _doFinalize: function () {
      ...
      this._process();
      for (o = this._hash, i = o.words, s = 0, undefined; s < 5; s++) {
        var o;
        var i;
        var s;
        var a = i[s];
...
module.exports = M_random_stuff_maybe.RIPEMD160;
