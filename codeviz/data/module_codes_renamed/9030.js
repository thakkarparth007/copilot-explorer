...
const M_filter_NOTSURE = require("filter"),
  M_granularity_NOTSURE = require("granularity"),
  i = M_filter_NOTSURE.Filter.CopilotClientTimeBucket;
exports.GranularityDirectory = class {
  constructor(e, t) {
    this.specs = new Map();
    this.prefix = e;
    this.clock = t;
    this.defaultGranularity = M_granularity_NOTSURE.DEFAULT_GRANULARITY(e);
  }
  selectGranularity(e) {
  ...
  update(e, t, n) {
    ...
    if (isNaN(t) && isNaN(n)) this.specs.delete(e);
      ...
      const r = new M_granularity_NOTSURE.TimeBucketGranularity(this.prefix);
