...
const r = require("path"),
  M_esprima_parser_NOTSURE = require("esprima_parser"),
  M_esprima_parser_NOTSURE = require("esprima_parser");
var s;
!(function (e) {
  e.Python = "python";
...
async function getLanguage(e) {
  ...
  if (!_.has(t)) {
    const e = await (async function (e) {
      await M_esprima_parser_NOTSURE.init();
      const t = r.resolve(__dirname, "..", "dist", `tree-sitter-${e}.wasm`);
      return M_esprima_parser_NOTSURE.Language.load(t);
    })(t);
    _.set(t, e);
  }
  return _.get(t);
...
async function parseTree(e, t) {
  ...
  const r = new M_esprima_parser_NOTSURE();
  r.setLanguage(n);
  const i = r.parse(t);
  r.delete();
  return i;
