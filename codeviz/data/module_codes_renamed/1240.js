...
const M_codegen_NOTSURE = require("codegen"),
  M_discr_error_NOTSURE = require("discr-error"),
  i = {
    ...
    code(e) {
      ...
      const u = t.let("valid", !1),
        d = t.const(
          "tag",
          M_codegen_NOTSURE._`${n}${M_codegen_NOTSURE.getProperty(l)}`
        );
      function p(n) {
        ...
        e.mergeEvaluated(i, M_codegen_NOTSURE.Name);
        return o;
      }
      t.if(
        M_codegen_NOTSURE._`typeof ${d} == "string"`,
        () =>
          (function () {
            const n = (function () {
              var e;
            ...
            t.if(!1);
            for (const e in n) {
              t.elseIf(M_codegen_NOTSURE._`${d} === ${e}`);
              t.assign(u, p(n[e]));
            }
            t.else();
            e.error(!1, {
              discrError: M_discr_error_NOTSURE.DiscrError.Mapping,
              tag: d,
              tagName: l,
            });
            t.endIf();
        ...
        () =>
          e.error(!1, {
            discrError: M_discr_error_NOTSURE.DiscrError.Tag,
            tag: d,
            tagName: l,
          })
      );
