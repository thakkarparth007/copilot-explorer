...
module.exports = (r = require(8249), require(888), void (r.lib.Cipher || (o = r, i = o.lib, s = i.Base, a = i.WordArray, c = i.BufferedBlockAlgorithm, l = o.enc, l.Utf8, u = l.Base64, d = o.algo.EvpKDF, p = i.Cipher = c.extend({
  cfg: s.extend(),
  ...
  function t(e, t, n) {
    var r,
      o = this._iv;
    o ? (r = o, this._iv = undefined) : r = this._prevBlock;
  ...
  _doFinalize: function () {
    var e,
      t = this.cfg.padding;
    this._xformMode == this._ENC_XFORM_MODE ? (t.pad(this._data, this.blockSize), e = this._process(!0)) : (e = this._process(!0), t.unpad(e));
    return e;
  },
  blockSize: 4
  ...
  parse: function (e) {
    var t,
      n = u.parse(e),
      r = n.words;
    1398893684 == r[0] && 1701076831 == r[1] && (t = a.create(r.slice(2, 4)), r.splice(0, 4), n.sigBytes -= 16);
    return _.create({
      ciphertext: n,
      salt: t
    });
  ...
  decrypt: function (e, t, n, r) {
    ...
    r.iv = o.iv;
    return v.decrypt.call(this, e, t, o.key, r);
  }
}))));